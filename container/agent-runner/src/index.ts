...
async function main(): Promise<void> {
  ...
  // Done once — these are fixed at container creation time.
  ...
  try {
    while (true) {
      ...
      const queryResult = await runQuery(prompt, sessionId, mcpServerPath, containerInput, sdkEnv, extraDirs, resumeAt);
